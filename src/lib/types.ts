...
export const translations = {
  fr: {
    ...
    experience: {
      ...
      job1: {
        ...
        description: "Organisation des données graphiques et contribution à des projets de rebranding."
      },
      job2: {
        ...
        company: "Enolia",
        tasks: [
          "Automatisation de la récupération de données en utilisant des techniques de web scraping.",
          "Développement d'une interface de traitement des données sous PHP/MySQL."
        ]
      }
    },
  ...
  en: {
    ...
    intro: {
      ...
      description: "As a second-year engineering student at Polytech Annecy, aspiring to become a data scientist, I am looking for an internship of maximum 4 months and minimum 6 weeks starting from May 19th, 2025, and a one-year apprenticeship (professional training contract) starting from October 2025. Passionate about data analysis and solving complex problems, I distinguish myself by my rigor, curiosity, and ability to translate data into concrete solutions.",
    ...
    experience: {
      ...
      job1: {
        ...
        company: "Billboards Media Group",
        description: "Organization of graphic data and contribution to rebranding projects."
      },
      job2: {
        ...
        company: "Enolia",
        tasks: [
          "Automation of data retrieval using web scraping techniques.",
          "Development of a data processing interface using PHP/MySQL."
        ]
      }
    },
